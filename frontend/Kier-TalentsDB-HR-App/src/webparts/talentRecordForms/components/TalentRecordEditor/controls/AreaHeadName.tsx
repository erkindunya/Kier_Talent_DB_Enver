...
@observer
class AreaHeadName extends React.Component<any, any> {

  render() {

    /*
        const options = (this.props.store.ViewStore.isEditing && this.props.store.Talent.AreaHead.value=="")?{
    ...
    */
    ...
    const options = {
      initialValue: this.props.store.Talent.AreaHeadName,
