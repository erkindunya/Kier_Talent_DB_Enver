...
exports.DevelopmentRequirementsLookupDataStore = mobx_state_tree_1.types.model({
    ...
    var _dataProvider = DataProviderFactory_1.DataProviderFactory.GetDevelopmentRequirementsLookupDataProvider();
    //loading all business items
    var loadDevelopmentRequirements = mobx_state_tree_1.flow(function loadDevelopmentRequirements() {
    ...
    return {
        loadDevelopmentRequirements: loadDevelopmentRequirements
    };
});
//# sourceMappingURL=DevelopmentRequirementsDataStore.js.map